...
{
    public abstract class TinTucCongNgheWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TinTucCongNgheWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TinTucCongNgheWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TinTucCongNgheDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TinTucCongNgheDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TinTucCongNgheDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TinTucCongNgheDbContext, Task<T>> func)
        {
            T result;
