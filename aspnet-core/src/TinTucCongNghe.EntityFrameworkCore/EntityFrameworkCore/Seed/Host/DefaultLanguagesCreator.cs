...
namespace TinTucCongNghe.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TinTucCongNgheConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TinTucCongNgheDbContext context)
        {
            _context = context;
        }
